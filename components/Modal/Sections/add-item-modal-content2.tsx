    ...
    try {
      ...
      if (res.message.toLowerCase() === "success") {
        ...
        cartObj.itemString =
          ...
          itemData.ItemName +
          preferenceName +
          (custOptsData.custom_desc
            ?.map((desc) => `${desc.item_cust_values}`)
            .join("|") || "");
        ...
        console.log("item string", cartObj.itemString);
    ...
    <div>
      ...
      <DialogFooter className="sticky bottom-0 left-0 bg-background pt-4 mt-4 pb-6">
        <div className="flex flex-col gap-2 w-full">
          ...
          <div className="bg-primary flex items-center justify-between p-2 w-full"
          style={{borderRadius:"25px"}}>
            ...
            <Button
              className="bg-white text-primary rounded-[20px]"
