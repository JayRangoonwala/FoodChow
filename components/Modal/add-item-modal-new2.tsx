...
export default function AddItemModal({
  ...
  const {setPendingDeal}=useContext(MyContext)
  ...
  return (
    <>
      <Dialog open={openAddItem} onOpenChange={setOpenAddItem} >
        <Button
          variant={"outline"}
          className={  cn("rounded-[20px]",exists && "absolute top-[112px] left-[34px] ")}
        ...
        <DialogContent className="max-h-[calc(100vh-150px)] pb-0  w-[500px]">
          <AddItemModalContent
            itemData={itemData}
