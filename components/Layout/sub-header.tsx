...
export default function SubHeader({
  ...
  return (
    <div className="pt-[72px] fixed top-0 z-0 px-3 lg:px-6 py-2 w-full flex flex-col gap-2" id="sub-header">
      <span className="text-lg font-medium block lg:hidden text-center">
        Additional Menu
      </span>
      <div className="flex gap-2 lg:justify-start justify-center overflow-x-auto font-sans">
